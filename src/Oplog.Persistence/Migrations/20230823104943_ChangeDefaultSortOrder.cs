...
{
    /// <inheritdoc />
    public partial class ChangeDefaultSortOrder : Migration
    {
        /// <inheritdoc />
...
IF @SortField IS NOT NULL
    SET @sql += @SortField + IIF(@SortDirection = 'ASC', '', ' DESC') + ', EffectiveTime' + IIF(@SortDirection = 'ASC', '', ' DESC');
ELSE
	SET @sql += 'EffectiveTime' + IIF(@SortDirection = 'ASC', '', ' DESC');
...
IF @SortField IS NOT NULL
    SET @sql += @SortField + IIF(@SortDirection = 'DESC', ' DESC', '') + ', EffectiveTime' + IIF(@SortDirection = 'DESC', ' DESC', '');
ELSE
	SET @sql += 'EffectiveTime' + IIF(@SortDirection = 'DESC', ' DESC', '');
